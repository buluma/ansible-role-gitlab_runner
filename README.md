...
|------|------|---------|-------|
|[![github](https://github.com/buluma/ansible-role-gitlab_runner/workflows/Ansible%20Molecule/badge.svg)](https://github.com/buluma/ansible-role-gitlab_runner/actions)|[![gitlab](https://gitlab.com/shadowwalker/ansible-role-gitlab_runner/badges/master/pipeline.svg)](https://gitlab.com/shadowwalker/ansible-role-gitlab_runner)|[![downloads](https://img.shields.io/ansible/role/d/buluma/gitlab_runner)](https://galaxy.ansible.com/buluma/gitlab_runner)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-gitlab_runner.svg)](https://github.com/buluma/ansible-role-gitlab_runner/releases/)|
